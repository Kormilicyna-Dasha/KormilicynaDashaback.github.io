...
// Получаем статистику (без использования created_at)
try {
    // Общее количество заявок
    $total_applications = $pdo->query("SELECT COUNT(*) FROM applications")->fetchColumn();
    
    // Получаем все заявки (без сортировки по created_at)
    ...
    <div class="container">
                ...
                <div class="row">
                    <?php foreach ($stats as $stat): ?>
                        <div class="col-md-3 mb-2">
                            <span class="badge badge-primary p-2 w-100">
        ...
        <div class="card">
            <div class="card-header bg-dark text-white d-flex justify-content-between">
                ...
                <span class="badge badge-light"><?= $total_applications ?></span>
            </div>
